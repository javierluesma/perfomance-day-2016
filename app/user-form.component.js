System.register(['angular2/core', 'angular2/common', 'angular2/router', './user', './users.service', './email.Validator'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, router_1, user_1, users_service_1, email_Validator_1;
            ...
            UserFormComponent = (function () {
                function UserFormComponent(fb, _router, _routeParams, _userService) {
                    ...
                    this.form = fb.group({
                        ...
                        email: ['', email_Validator_1.EmailValidator.validEmail],
                        phone: [],
                        address: fb.group({
                            street: [],
                            suite: [],
